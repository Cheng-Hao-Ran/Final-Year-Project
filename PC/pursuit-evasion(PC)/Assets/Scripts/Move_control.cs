...
public class Move_control : MonoBehaviour
{
    ...
    public void Move()
    {
        ...
        // When the robber starts to move, it has a chance to select direcion
        ...
        // When the robber meets a corner during the move, arrrows will show and give the robber another chance for direction
        ...
        if (turnSuc == 1)
        {
            ...
            // Record 50 times when moving
            if (timer == 50)
            {
                // Judge whether it meets a Cop
                ...
                //Update its position for each step
                ...
                // Update its left steps in the information in the game
    ...
    // Using teleprot when ends at a teleprot cube
    ...
    // Call different steps function when click different steps in the game
    public void Step1()
    {
        if (step == 0 || step==-1)
        {
    ...
    // change the direction of the robber
