...
public class GameManager : MonoBehaviour
{
    ...
    void FixedUpdate()
    {
        // When the player click step, the robber starts to move
        ...
        // After the robber moves, the first cop moves
        if (Data.cop.suc == 1)
        {
            Data.cop.move(0);
        }

        // After the the first moves, the second cop moves
        if (Data.cop1.suc == 1)
        {
            Data.cop1.move(1);
        }

        // To use if the turns equals to 0, the robber win
